...
STAGES
 ● 01 framing      4d ago
 ● 02 literature   2d ago
 ● 03 methodology  2d ago
 ● 03 artifacts    2d ago
 ● 04 evaluation   8d ago     ← stale, currently focused
 ○ 05 report       never
```

Five canonical stages, in this order: `framing`, `literature`, `methodology`, `artifacts`, `evaluation`, `report`. Each row carries a status pip + label + last-run age. Selected stage uses inverse-video amber.
...
- Status line: focused stage status, then aggregate counts (`5 stages · 4 fresh · 1 stale · 1 queued`), then run cost vs budget.
