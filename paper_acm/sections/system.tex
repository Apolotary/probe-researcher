...
\begin{figure*}[t]
\centering
\includesvg[width=\linewidth]{figures/pipeline}
...
7 & Adversarial review ($\times 3$ + meta) & Opus 4.7 & Sustained role-separation, refuse consensus \\
...
\begin{figure*}[t]
\centering
\includesvg[width=\linewidth]{figures/audit_finding}
