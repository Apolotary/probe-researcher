...
\subsection{Rehearsal as a productive, not merely defensive, framing}

The project's tagline is ``rehearsal stage for research; the performance still needs humans.'' The defensive reading is: simulated walkthroughs are not evidence, and the linter enforces that they not use evidence language. The more productive reading is: simulated walkthroughs generate \emph{falsifiable hypotheses} about study-design weaknesses. A rehearsal sentence like ``a fast H-key navigator would traverse all three H2s in under four seconds'' is a prediction the real study either confirms or refutes. The \texttt{[SIMULATION\_REHEARSAL]} tag reframes simulation-as-evidence into simulation-as-pre-registered-prior.
